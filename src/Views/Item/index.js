        ...
        if (unit) {
          return (
            ...
            <per style={{
              fontSize: "20px", maxWidth: "10px",
              wordWrap: "break-word"
            }}>{unit.find(o => o.id === row.salsunit).name}</per>
          )
        }
      }
    }, {
      ...
      formatter: (cellCnotent, row) => {
        if (unit) {
          ...
          <per style={{
            fontSize: "20px", maxWidth: "10px",
            wordWrap: "break-word"
          }}>{unit.find(o => o.id === row.entryunit).name}</per>
        )}
      }
    }, {
      ...
      formatter: (cellCnotent, row) => {
        return (
          <per style={{
            fontSize: "20px", maxWidth: "10px",
            wordWrap: "break-word"
          }}>{row.packetsize + " "+unit.find(o => o.id === row.salsunit).name+"/"+ unit.find(o => o.id === row.entryunit).name} </per>
        )
      }
    }, {
      dataField: 'price',
